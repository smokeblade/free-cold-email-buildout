  ...
  return (
    <main className="min-h-[60vh] flex flex-col items-center justify-center gap-6 px-6 py-24">
      ...
      <p className="text-base sm:text-lg text-center max-w-2xl text-black/70 dark:text-white/70">
        We build your cold email infrastructure for free. You cover software and
        inbox costs. We earn via affiliate. No tricks.
      </p>
      <div className="flex items-center gap-3">
        ...
        <a
          href="/how-it-works"
          className="rounded-md border border-black/10 hover:bg-black/[.03] px-5 py-3 text-sm sm:text-base"
        >
          How it works
        </a>
      </div>
