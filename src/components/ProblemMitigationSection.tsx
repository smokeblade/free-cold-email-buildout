  ...
  const onvallyBenefits = [
    {
      ...
      text: "Setup completely free"
    },
    {
      icon: <Check className="w-5 h-5 text-blue-500" />,
      text: "DNS + inbox configuration included"
    },
    {
      icon: <Check className="w-5 h-5 text-blue-500" />,
      text: "You only pay software providers directly"
    },
    {
      icon: <Check className="w-5 h-5 text-blue-500" />,
      text: "Deliverability-friendly templates included"
    }
  ];
        ...
        <div className="rounded-[48px] overflow-hidden shadow-sm">
          <div className="bg-gradient-to-b from-white to-[#F5F6F7]/70 p-6 md:p-10">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">Launch cold email safely, without burning domains</h2>
              <p className="mt-3 text-base md:text-lg text-gray-700">DNS configured correctly, inbox warmup, safe sending limits, and deliverability‑friendly templates—so you can prospect without destroying your reputation.</p>
            </div>
            ...
            <div className="mt-10 grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
              ...
              <div className="rounded-[28px] border border-gray-100 bg-white p-6 md:p-8 shadow-sm">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900">Cold Email Launchpad</h3>
                  <div className="text-right">
                    <div className="text-xs text-gray-500">Your spend</div>
                    <div className="text-2xl font-semibold text-blue-600">Just software costs</div>
                  </div>
                </div>
                <div className="mt-5 space-y-3">
            ...
            <div className="mt-10 md:mt-12 text-center">
              ...
              <div className="mt-3 text-xs text-gray-500">Setup is completely free. You only pay software providers directly at their standard rates.</div>
            </div>
          </div>
        </div>
      </div>
