...
const bullets = ['Monthly closes and reconciliations', 'AP/AR processing', 'Clean reporting and audit prep'];
const outcomes = ['Timely books', 'Better cash visibility', 'Fewer surprises'];
const reviews = [
  { quote: 'Close time cut in half.', author: 'Elaine T — CFO' },
  { quote: 'Accurate, timely books every month.', author: 'Gabe U — Owner' },
  { quote: 'Cash visibility finally makes sense.', author: 'Imani C — Finance' },
  { quote: 'Audit prep is painless now.', author: 'Tim R — Controller' },
];

const role = roles.find(r => r.slug === 'bookkeeper');
    ...
    <section className="pt-28 md:pt-32 pb-10" style={{ background: '#F5F6F7' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center rounded-[40px] overflow-hidden bg-gradient-to-b from-white to-[#F5F6F7] p-8 md:p-12">
          <div>
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">Bookkeeper</h1>
            <p className="mt-3 md:text-lg text-gray-700">Closes, reconciliations, AP/AR, and clean reports—on time, every month.</p>
          ...
          <div>
            <div className="relative rounded-3xl overflow-hidden bg-black/5 aspect-[4/3] md:aspect-[16/10]">
              <img src="https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?q=80&w=2000&auto=format&fit=crop" alt="Bookkeeping" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-3 grid sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-gray-200 p-4">
                <div className="text-sm font-medium text-gray-500">US hire (Bookkeeper)</div>
              ...
              <div className="rounded-2xl border border-blue-200 p-4 bg-blue-50/40">
                <div className="text-sm font-medium text-blue-600">onvally Bookkeeper</div>
