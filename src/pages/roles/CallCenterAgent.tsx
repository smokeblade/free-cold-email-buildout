...
const bullets = ['Inbound and outbound calls', 'Scripted QA‑driven conversations', 'CRM logging and follow‑ups'];
const outcomes = ['Higher answer rates', 'Consistent QA', 'Clean call notes'];
const reviews = [
  { quote: 'Professional phone presence.', author: 'Ana M — Ops' },
  { quote: 'Follow‑ups no longer slip.', author: 'Leo J — Sales' },
  { quote: 'QA scores improved across the board.', author: 'Uma N — QA Lead' },
  { quote: 'Answer rates are consistently higher.', author: 'Pat R — Support' },
];

const role = roles.find(r => r.slug === 'call-center-agent');

const CallCenterAgent: React.FC = () => (
    ...
    <section className="pt-28 md:pt-32 pb-10" style={{ background: '#F5F6F7' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center rounded-[40px] overflow-hidden bg-gradient-to-b from-white to-[#F5F6F7] p-8 md:p-12">
          <div>
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">Call Center Agent</h1>
            <p className="mt-3 md:text-lg text-gray-700">Dependable call coverage with scripts, QA, and CRM hygiene.</p>
          ...
          <div>
            <div className="relative rounded-3xl overflow-hidden bg-black/5 aspect-[4/3] md:aspect-[16/10]">
              <img src="https://images.unsplash.com/photo-1525182008055-f88b95ff7980?q=80&w=2000&auto=format&fit=crop" alt="Call Center" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-3 grid sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-gray-200 p-4">
                <div className="text-sm font-medium text-gray-500">US hire (Call Center Agent)</div>
              ...
              <div className="rounded-2xl border border-blue-200 p-4 bg-blue-50/40">
                <div className="text-sm font-medium text-blue-600">onvally Call Center</div>
