...
const bullets = ['Ticket triage and replies', 'Macros/SOPs maintenance', 'Chat coverage and CSAT tracking'];
const outcomes = ['Faster responses', 'Higher CSAT', 'Clean ticket analytics'];
const reviews = [
  { quote: 'Our FRT dropped by 43% with consistent coverage.', author: 'Nora T — Support Lead' },
  { quote: 'We finally have meaningful CSAT reporting.', author: 'Jill M — Ops' },
  { quote: 'Macros and QA improved consistency.', author: 'Ben G — CX' },
  { quote: 'Coverage gaps are gone.', author: 'Kara V — COO' },
];

const role = roles.find(r => r.slug === 'customer-support');
    ...
    <section className="pt-28 md:pt-32 pb-10" style={{ background: '#F5F6F7' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center rounded-[40px] overflow-hidden bg-gradient-to-b from-white to-[#F5F6F7] p-8 md:p-12">
          <div>
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">Customer Support Virtual Assistant</h1>
            <p className="mt-3 md:text-lg text-gray-700">Help desk, chat, and email ticketing with clear SLAs and quality controls.</p>
          ...
          <div>
            <div className="relative rounded-3xl overflow-hidden bg-black/5 aspect-[4/3] md:aspect-[16/10]">
              <img src="https://images.unsplash.com/photo-1525182008055-f88b95ff7980?q=80&w=2000&auto=format&fit=crop" alt="Support" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-3 grid sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-gray-200 p-4">
                <div className="text-sm font-medium text-gray-500">US hire (Customer Support)</div>
              ...
              <div className="rounded-2xl border border-blue-200 p-4 bg-blue-50/40">
                <div className="text-sm font-medium text-blue-600">onvally Support VA</div>
