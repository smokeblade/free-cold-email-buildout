...
const bullets = ['CRM updates and dedupe', 'Spreadsheet maintenance', 'Web research and list building'];
const outcomes = ['Accurate systems', 'Cleaner reports', 'Time back to ops'];
const reviews = [
  { quote: 'Error rate went near‑zero.', author: 'Sam K — Operations' },
  { quote: 'Freed 15h/week for our team.', author: 'Irene P — PM' },
  { quote: 'Everything in the CRM is up to date now.', author: 'Lior H — VP Ops' },
  { quote: 'Reporting accuracy improved immediately.', author: 'Nate W — COO' },
];

const role = roles.find(r => r.slug === 'data-entry');
    ...
    <section className="pt-28 md:pt-32 pb-10" style={{ background: '#F5F6F7' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center rounded-[40px] overflow-hidden bg-gradient-to-b from-white to-[#F5F6F7] p-8 md:p-12">
          <div>
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">Data Entry Virtual Assistant</h1>
            <p className="mt-3 md:text-lg text-gray-700">High‑accuracy data input, CRM hygiene, and research that keeps your ops clean.</p>
          ...
          <div>
            <div className="relative rounded-3xl overflow-hidden bg-black/5 aspect-[4/3] md:aspect-[16/10]">
              <img src="https://images.unsplash.com/photo-1551281044-8e8b56c7a8b5?q=80&w=2000&auto=format&fit=crop" alt="Data Entry" className="absolute inset-0 h-full w-full object-cover" />
      ...
      <div className="max-w-7xl mx-auto px-6 rounded-[32px] bg-white p-6 md:p-10 border border-gray-200/70">
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-blue-50 text-blue-700 px-4 py-2 text-sm font-medium">Typical ramp: 5 days</div>
          </div>
        </div>
      </div>
    </section>
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-3 grid sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-gray-200 p-4">
                <div className="text-sm font-medium text-gray-500">US hire (Data Entry)</div>
              ...
              <div className="rounded-2xl border border-blue-200 p-4 bg-blue-50/40">
                <div className="text-sm font-medium text-blue-600">onvally Data Entry</div>
