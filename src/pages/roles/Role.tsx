...
const AutoCarousel: React.FC<{ reviews: Role['reviews'] }> = ({ reviews }) => {
    ...
    <div className="min-h-screen font-inter">
      ...
      <section className="pt-28 md:pt-32 pb-10" style={{ background: '#F5F6F7' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 items-center rounded-[40px] md:rounded-[56px] overflow-hidden bg-gradient-to-b from-white to-[#F5F6F7] p-8 md:p-12">
            <div>
              <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">{role.name}</h1>
              <p className="mt-3 md:text-lg text-gray-700">{role.blurb}</p>
              <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-blue-50 text-blue-700 px-4 py-2 text-sm font-medium">Starting from {role.startingFrom}</div>
            ...
            <div>
              <div className="relative rounded-3xl overflow-hidden bg-black/5 aspect-[4/3] md:aspect-[16/10]">
                <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2000&auto=format&fit=crop" alt={role.name} className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="rounded-[32px] bg-white p-6 md:p-10 border border-gray-200/70">
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div>
                ...
                <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-blue-50 text-blue-700 px-4 py-2 text-sm font-medium">Typical ramp: {role.rampDays} days</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto px-6">
          <AutoCarousel reviews={role.reviews} />
        </div>
      </section>
            ...
            <div className="md:col-span-2">
              ...
              <div className="mt-3 grid sm:grid-cols-2 gap-4">
                <div className="rounded-2xl border border-gray-200 p-4">
                  <div className="text-sm font-medium text-gray-500">US hire ({role.name})</div>
                ...
                <div className="rounded-2xl border border-blue-200 p-4 bg-blue-50/40">
                  <div className="text-sm font-medium text-blue-600">onvally {role.name}</div>
