...
const bullets = [
  ...
  'Qualification and booked meetings',
];

const outcomes = ['More qualified pipeline', 'Lower CPL', 'Predictable meetings/week'];

const reviews = [
  { quote: 'Booked meetings doubled in 30 days.', author: 'Victor L — VP Sales' },
  { quote: 'Hand‑offs to AEs are consistent and qualified.', author: 'Paula C — AE' },
  { quote: 'Reply rates improved with better targeting.', author: 'Rohan S — SDR Manager' },
  { quote: 'Pipeline quality is noticeably higher.', author: 'Kim A — CRO' },
];

const role = roles.find(r => r.slug === 'sales-sdr');

const SalesSDR: React.FC = () => (
    ...
    <section className="pt-28 md:pt-32 pb-10" style={{ background: '#F5F6F7' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 items-center rounded-[40px] overflow-hidden bg-gradient-to-b from-white to-[#F5F6F7] p-8 md:p-12">
          <div>
            <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-gray-900">Sales Development Representative (SDR)</h1>
            <p className="mt-3 md:text-lg text-gray-700">Prospecting, multi‑channel outreach, and qualified meetings for your AEs.</p>
            <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-blue-50 text-blue-700 px-4 py-2 text-sm font-medium">Starting from $1,595 / month</div>
          ...
          <div>
            <div className="relative rounded-3xl overflow-hidden bg-black/5 aspect-[4/3] md:aspect-[16/10]">
              <img src="https://images.unsplash.com/photo-1525182008055-f88b95ff7980?q=80&w=2000&auto=format&fit=crop" alt="SDR" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-3 grid sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-gray-200 p-4">
                <div className="text-sm font-medium text-gray-500">US hire (SDR)</div>
              ...
              <div className="rounded-2xl border border-blue-200 p-4 bg-blue-50/40">
                <div className="text-sm font-medium text-blue-600">onvally SDR</div>
